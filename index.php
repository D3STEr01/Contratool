...
<body>
  ...
  <div class="sidebar">
    ...
    <hr>
    <a href="imoveis.php">+ Registrar Imóvel</a>
  ...
  <div class="content">
    <div class="card-login">
      <div class="topo">
        ...
        <h5>
          <a href="rcliente.php" class="btn btn-primary btn-xs">
        ...
        <tbody>
          <tr>
            <th class="rows">
              ...
              $result_msg_cont = "SELECT * FROM tbl_clientes ORDER BY cli_id DESC";

              //Seleciona os registros
              $resultado_msg_cont = $pdo->prepare($result_msg_cont);
              $resultado_msg_cont->execute();
              while ($row_msg_cont = $resultado_msg_cont->fetch(PDO::FETCH_ASSOC)) {
                echo "<br><br>" . $row_msg_cont['cli_id'] . "";
            ...
            <td>
              ...
              $resultado_msg_cont->execute();
              while ($row_msg_cont = $resultado_msg_cont->fetch(PDO::FETCH_ASSOC)) {
                echo "<br><br>" . $row_msg_cont['cli_nome'] . "";
            ...
            <td>
              ...
              while ($row_msg_cont = $resultado_msg_cont->fetch(PDO::FETCH_ASSOC)) {
                ...
                echo "<br><br> " . $row_msg_cont['cli_cpf'] . "";
              }
              ?>
            </td>
            <hr>
            <td>
              ...
              $resultado_msg_cont->execute();
              while ($row_msg_cont = $resultado_msg_cont->fetch(PDO::FETCH_ASSOC)) {
                echo "<br><br>" . $row_msg_cont['cli_email'] . "";
              }
              ?>
            </td>
            <hr>
            <td>
              ...
              $resultado_msg_cont->execute();
              while ($row_msg_cont = $resultado_msg_cont->fetch(PDO::FETCH_ASSOC)) {
                echo "<br><br>" . $row_msg_cont['cli_telefone'] . "";
              }
              ?>
            </td>
            <hr>
            <td>
              ...
              $resultado_msg_cont->execute();
              while ($row_msg_cont = $resultado_msg_cont->fetch(PDO::FETCH_ASSOC)) {
                echo "<br><br>" . $row_msg_cont['cli_endereco'] . "<a href='rclienteperfil.php' class='ml-5 '> Olhar
              </a>";
              }
              ?>
